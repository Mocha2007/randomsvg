...
def paint():
	#opening
	open("art/burningship.svg","w+").write('<?xml version="1.0" standalone="no"?>')
	open("art/burningship.svg","a").write('<svg width="'+str(side)+'" height="'+str(side)+'" version="1.1" xmlns="http://www.w3.org/2000/svg">\n<desc>'+name+'</desc>')
	...
	open("art/burningship.svg","a").write(please)
	#end
	open("art/burningship.svg","a").write('\n<text x="48" y="'+str(side-48)+'" font-family="Verdana" font-size="48">\n\t'+name+'\n</text>')
	open("art/burningship.svg","a").write('\n</svg>')
